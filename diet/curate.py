...
CURATE_PICKS: list[Pick] = [
    ...
    Pick("natural peanut butter", include=("peanut butter",), exclude=("powder", "cup", "filled"),
         # The selected Kroger product is standard full-fat peanut butter, not
         # the reduced-fat profile ranked first by FDC's broad text search.
         fdc_query="174266",
         dietary_categories=("legume", "nut")),
    Pick("dry roasted unsalted peanuts", include=("peanuts", "unsalted"),
         exclude=("butter", "mixed", "in-shell", "shell-on", "candy", "chocolate"),
         fdc_query="peanuts all types dry roasted without salt",
         dietary_categories=("legume", "nut")),
    Pick("raw cashews", include=("raw", "cashews"),
         exclude=("chocolate", "candy", "butter", "milk", "bar"),
         # The newer Foundation record omits several tracked micronutrients;
         # use the complete SR Legacy profile selected during exact lookup.
         fdc_query="170162",
         dietary_categories=("nut",)),
    Pick("shelled pistachios", include=("shelled", "pistachios"),
         exclude=("chocolate", "candy", "butter", "ice cream", "in-shell"),
         fdc_query="nuts pistachio nuts dry roasted with salt added",
         dietary_categories=("nut",)),
    Pick("raw almonds", include=("raw", "almonds"),
         exclude=("butter", "milk", "flour", "chocolate", "candy", "bar"),
         fdc_query="170567",
         dietary_categories=("nut",)),
    Pick("walnuts", include=("walnut", "halves"),
         exclude=("candy", "sugar", "salted", "chocolate", "coated", "honey",
                  ...
                  "concealer", "cosmetic", "makeup", "beauty"),
         fdc_query="170187",
         dietary_categories=("nut",)),
    Pick("pecan halves", include=("pecan", "halves"),
         exclude=("pie", "candy", "sweetened", "glazed", "chocolate", "butter"),
         fdc_query="170182",
         dietary_categories=("nut",)),
    Pick("roasted hazelnuts", include=("hazelnut",),
         exclude=("spread", "cocoa", "chocolate", "coffee", "creamer", "candy",
                  "cookie", "bar", "milk", "butter"),
         fdc_query="170583",
         dietary_categories=("nut",)),
    Pick("macadamia nuts", include=("macadamia",),
         exclude=("chocolate", "cookie", "bar", "milk", "butter", "oil", "trail mix"),
         fdc_query="nuts macadamia nuts dry roasted with salt added",
         dietary_categories=("nut",)),
    Pick("pine nuts", include=("pine nuts",),
         exclude=("pineapple", "mixed", "pesto", "salad", "bar"),
         fdc_query="nuts pine nuts dried",
         dietary_categories=("nut",)),
    ...
    Pick("fresh cabbage", include=("cabbage",),
         ...
         dietary_categories=("vegetable",)),
    Pick("whole kernel corn", include=("whole kernel", "corn"),
         exclude=("creamed", "fire roasted", "mexicorn", "pepper", "soup"),
         fdc_query="corn sweet yellow canned brine pack regular pack solids and liquids",
         dietary_categories=("vegetable",)),
    Pick("black olives", include=("pitted", "black olives"),
         exclude=("oil", "tapenade", "salad", "pizza", "to go"),
         fdc_query="olives ripe canned small extra large",
